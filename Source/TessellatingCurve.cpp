...
#pragma region Configue
	std::string shader_dir = "./Shaders/TessellatingCurve/";
	Shader shader{ shader_dir + "curve.vs", shader_dir + "curve.fs", "", shader_dir + "curve.tcs", shader_dir + "curve.tes" };
	...
	vao.AddBuffer(0, 2, GL_FLOAT, false, 2 * sizeof(float), 0);
	vao.Bind();
