/*
	在着色表面上生成线框结构;
	当片元距离三角形边缘一定距离时，它将被着色并与边缘颜色混合。否则，片元将被正常着色。
*/
...
#pragma region Configue
	std::string shader_dir = "./Shaders/Wireframe/";
	Shader shader{ shader_dir + "wireframe.vs", shader_dir + "wireframe.fs", shader_dir + "wireframe.gs" };
