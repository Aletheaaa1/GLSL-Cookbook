...
#pragma region Configue
	...
	Shader shader{ "./Shaders/SamplerObject/sampler_object.vs", "./Shaders/SamplerObject/sampler_object.fs" };
	glm::vec3 lightPos = glm::vec3(10.0f, 20.0f, 0.0f);
	glm::vec3 lightColor = glm::vec3(1.0f);

	unsigned int texture = LoadTexture("./Textures/box.png");

	//	Generate Sampler Objects
	unsigned int samplers[2];
	glGenSamplers(2, samplers);
	unsigned int linear_sampler = samplers[0];
	unsigned int nearest_sampler = samplers[1];
